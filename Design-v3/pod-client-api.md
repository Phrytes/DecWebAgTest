...
This document is the contract for `@decwebag/pod-client` — the
...
Top-level package, not a subpath of `@decwebag/core`.  Both
`@decwebag/core` and external apps depend on it.
...
```js
import { CapabilityAuth } from '@decwebag/pod-client';
...
```js
import { SolidOidcAuth } from '@decwebag/pod-client';
import { SolidVault } from '@decwebag/core/storage';
...
```ts
import { writeWithConvention } from '@decwebag/pod-client/conventions';
...
```ts
import { encryptIfPrivate, decryptIfEncrypted } from '@decwebag/pod-client/conventions';
...
```js
import { PodClient, CapabilityAuth } from '@decwebag/pod-client';
...
```js
import { PodClient, SolidOidcAuth } from '@decwebag/pod-client';
import { SolidVault } from '@decwebag/core/storage';
...
await client.write('/decwebag/devices/device-9f3a2c1b.enc', encryptedBytes, {
