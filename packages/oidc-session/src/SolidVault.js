 ...
 * `@decwebag/core` Vault sense.  It's the Solid-OIDC session manager
 ...
 * as a peer to `@decwebag/oidc-session-rn`.  No code changes other
 ...
 * `@decwebag/oidc-session-rn` (uses `expo-auth-session` for the dance).
 *
 ...
 * `@decwebag/core`'s `VaultMemory` provides for our purposes here.  Callers
