 ...
 *
 * Mirrored in `@decwebag/oidc-session-rn` (keep both copies in sync).
 *
 ...
 *   `@decwebag/oidc-session.createSolidAuthNode` returns this shape
 *   for Node; `@decwebag/oidc-session-rn.OidcSessionRN` returns the
