/**
 * @decwebag/vault — agent identity + token storage.
 *
 * Vault family:
 ...
 *                          OAuthVault.
 *
 * Extracted from `@decwebag/core/identity` 2026-05-11 (standardisation
 * Phase 50.1.A — see Project Files/SDK/core-v2-coding-plan-2026-05-11.md).
 * `@decwebag/core` keeps a deprecation re-export through one minor
 * release; new code should import from `@decwebag/vault` directly.
 */
