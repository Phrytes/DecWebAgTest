 ...
 *
 * Example:
 *   identityRoot = 'https://alice.example/decwebag/'
 *   uri          = 'https://alice.example/decwebag/grants/issued/grant-x.enc'
 ...
 *
 * @param   {object} podClient   `@decwebag/pod-client` PodClient.
 * @param   {string} identityRoot  e.g. `'https://alice.example/decwebag/'`.
