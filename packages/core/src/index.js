...
// ── Identity ────────────────────────────────────────────────────────────────
// Deprecated re-exports: the Vault family lives in `@decwebag/vault`
// since 2026-05-11 (standardisation Phase 50.1.A). The re-exports here
// keep existing `import { VaultMemory } from '@decwebag/core'` callers
// working during the deprecation window; new code should import from
// `@decwebag/vault` directly.
export {
  Vault,
  VaultMemory,
  VaultLocalStorage,
...
// `@decwebag/agent-registry` implements it). The in-memory helper is
...
// Deprecated re-export: `SolidVault` lives in `@decwebag/oidc-session` since
// 2026-05-11 (standardisation Phase 50.1). The re-export here keeps existing
// `import { SolidVault } from '@decwebag/core'` callers working during the
// deprecation window; new code should import from `@decwebag/oidc-session`.
export { SolidVault }        from '@decwebag/oidc-session';
