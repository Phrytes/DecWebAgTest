...
export class Agent extends Emitter {
   ...
   *  (standardisation Phase 50.3). Core never imports `@decwebag/pseudo-pod`; this is
   ...
   *  facade (standardisation Phase 50.8). Core never imports `@decwebag/agent-registry`;
   ...
   *  direction). Core never imports `@decwebag/interface-registry`; this is an opaque
   ...
   *  direction). Core never imports `@decwebag/protocol`; this is an opaque slot for the
   ...
   * (typically `@decwebag/pseudo-pod` for the storage slot,
   * `@decwebag/agent-registry` for the registry slot) handles the
   * actual delegation.
   *
   * Typical use, from `@decwebag/agent-provisioning` or a bundle's
   * own bring-up code:
   *
