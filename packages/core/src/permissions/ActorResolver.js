 ...
 * `@decwebag/agent-registry` (forthcoming) — that substrate reads the
 ...
 * never imports `@decwebag/agent-registry`. Apps + facades wire the
 ...
 *
 * Apps that need a real resolver (backed by `@decwebag/agent-registry`)
