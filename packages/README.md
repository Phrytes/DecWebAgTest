...
| `@decwebag/item-types` | Cross-app canonical type taxonomy (`task`, `note`, `chat-message`, …). JSON-Schema validator + `validateCanonical` adapter for item-store-shaped items. | 52.1 + 52.7 |
