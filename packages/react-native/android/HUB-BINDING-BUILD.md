...
`android/app/src/main/aidl/com/decwebag/hub/` directory at prebuild
...
<permission
    android:name="com.decwebag.hub.PERMISSION_BIND"
...
<uses-permission android:name="com.decwebag.hub.PERMISSION_BIND" />
```
...
```
android/src/main/java/com/decwebag/react/
...
if (hubInstalled) {
  const binding = await bind({
    ...
    intentAction: 'com.decwebag.hub.BIND',
    hubVersion:   1,
  });
  // …
}
