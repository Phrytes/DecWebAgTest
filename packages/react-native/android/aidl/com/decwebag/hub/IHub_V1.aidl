...
// `com.decwebag.hub.PERMISSION_BIND`. The Hub additionally checks the
// caller's package signature against its trusted-signers list.

package com.decwebag.hub;

import com.decwebag.hub.IIncomingCallback;
...
interface IHub_V1 {
     ...
     *
     * @param envelopeJson  the full envelope (matches @decwebag/notify-envelope's
