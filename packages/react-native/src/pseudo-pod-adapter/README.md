...
[`@decwebag/pseudo-pod`](../../../pseudo-pod). Apps wire one of
...
import { createPseudoPod } from '@decwebag/pseudo-pod';
...
- **Cache-mode write-through orchestration.** The dirty-set is
  ...
  substrate-side queue + drain logic lives in `@decwebag/pseudo-pod`
