/**
 * @decwebag/react-native/components — UI primitives shared across
 * mobile apps.
 *
 ...
 * `@decwebag/react-native/theme`. Apps must wrap their tree in
 * `<ThemeProvider value={tokens}>` (or accept the substrate's
 * neutral defaults).
 *
 * The QrCodeView / MnemonicView land at their own subpaths
 * (`@decwebag/react-native/qr/view` + `/mnemonic/view`) because
