...
// `@decwebag/react-native/platform/polyfills`.  Node / web bundlers
// see the sibling `polyfills.js` (no-op).
//
// Apps must import this BEFORE any other @decwebag substrate.  The
...
//
// @noble/hashes (pulled in by @scure/bip39 via @decwebag/core's
...
if (typeof crypto === 'undefined' || typeof crypto.getRandomValues !== 'function') {
  console.warn(
    '[@decwebag/react-native/platform/polyfills] crypto.getRandomValues unavailable. ' +
    'Did react-native-get-random-values fail to load? It must be in app peer-deps + ' +
    'this file must be imported before any other @decwebag substrate.',
  );
}
