...
// entry point BEFORE importing any other @decwebag substrate:
//
//   import '@decwebag/react-native/platform/polyfills';
//
// On Node this is a no-op.  On RN it wires up the polyfills.

if (typeof crypto === 'undefined' || typeof crypto.getRandomValues !== 'function') {
  console.warn(
    '[@decwebag/react-native/platform/polyfills] crypto.getRandomValues unavailable on this runtime. ' +
