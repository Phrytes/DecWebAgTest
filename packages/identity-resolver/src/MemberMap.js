...
export class MemberMap extends Emitter {
   ...
   *
   * Composes `@decwebag/pod-client.PodClient` via runtime injection — the
   ...
   *     }
   *
   * The `pubKey` slot is required by L1e (`@decwebag/skill-match`) for
   ...
   *   identifier (`@decwebag/core/identity/AgentIdentity.stableId`).
