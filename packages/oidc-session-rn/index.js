/**
 * @decwebag/oidc-session-rn — Solid OIDC sign-in for React Native.
 *
 ...
 *     (`@decwebag/oidc-session-rn/hook`). It pulls
...
// `@decwebag/oidc-session/src/issuers.js`; keep both copies in sync.
export {
  KNOWN_ISSUERS,
  DEFAULT_ISSUER_ID,
  DEFAULT_ISSUER,
