/**
 * Core types for @decwebag/notifier.  jsdoc only.
 */
 ...
 *
 * Surface (mirrored from `@decwebag/chat-agent`'s `MessagingBridge`):
 ...
 *
 * @typedef {import('@decwebag/chat-agent').MessagingBridge} Channel
 */

/**
 * @typedef {import('@decwebag/chat-agent').SendReplyArgs} ChannelDeliverArgs
 *   Deprecated alias kept for one release; new code should use
 *   `SendReplyArgs` from `@decwebag/chat-agent` directly.
 */
