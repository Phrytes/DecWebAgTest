/**
 * @decwebag/pod-client — Errors taxonomy.
 *
 ...
 * thrown by `@decwebag/core`'s storage layer (`SolidPodSource`,
...
/**
 * Base class for every error thrown by `@decwebag/pod-client`.
 *
...
/**
 * Map a raw `.code` string (as thrown by `@decwebag/core`'s storage layer)
