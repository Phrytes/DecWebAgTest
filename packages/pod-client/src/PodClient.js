 ...
 *
 * Auth choices (from `@decwebag/pod-client/Auth`):
...
// transitive install in `@decwebag/core/node_modules/`.  This keeps pod-client
...
export class PodClient extends Emitter {
   ...
   *   Optional `@decwebag/pseudo-pod`-shaped object. When supplied, any URI
