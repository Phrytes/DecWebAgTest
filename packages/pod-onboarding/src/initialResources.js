...
import { CONFIG_VERSION }      from '@decwebag/pod-routing';
import { buildDefaultPolicy }  from '@decwebag/pod-routing';
import { WEBID_PREDICATES }    from '@decwebag/webid-discovery';
...
export function buildInitialAgentRegistry({ agentInfo, podUri }) {
  ...
  // Shape matches @decwebag/agent-registry's expected agent record so
