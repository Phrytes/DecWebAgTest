/**
 * @decwebag/sync-engine-rn — React Native bootstrap helpers for the
 * decwebag sync-engine + pod-client.
 *
 * **Layer: SDK foundation (RN sibling).** Cross-platform sync logic
 * lives in `@decwebag/sync-engine`; this package is RN-only wiring
