 ...
 * cross-platform `@decwebag/sync-engine` substrate) and constructs
...
import { SyncEngine as SubstrateSyncEngine } from '@decwebag/sync-engine/SyncEngine';
import { createFsRN }              from '@decwebag/sync-engine/adapters/fsRN';
import { createHashRN }            from '@decwebag/sync-engine/adapters/hashRN';
import { createWatcherRN, DEFAULT_POLL_INTERVAL_MS } from '@decwebag/sync-engine/adapters/watcherRN';
