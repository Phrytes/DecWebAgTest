 ...
 *   `@decwebag/identity-resolver`. Apps can add/remove peers post-construction
 *   via `addPeer({pubKey})` / `removePeer(pubKey)`.
 */

import { publish, subscribe, unsubscribe } from '@decwebag/core';
...
export class SkillMatch {
  /** @type {import('@decwebag/core').Agent} */ #agent;
  /** @type {string}  */ #group;
  ...
  /**
   * @param {object} args
   * @param {import('@decwebag/core').Agent} args.agent  Real `core.Agent`.
