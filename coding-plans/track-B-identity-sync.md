...
green; full @decwebag/core suite 812 passed, 1 unrelated pre-existing
...
@decwebag/core.  Subscribe to bootstrap.onKeyRotated(...) for auth-log
...
- [x] 3. Implement IdentityPodStore class:
  - [x] `init(webid, bootstrap, podSource)` — create `/decwebag/` if absent, write initial manifest.
...
20 unit tests, all green; full @decwebag/core suite 1172 passed +
...
Hand-off:
  - B3 (IdentitySync) imports { IdentityPodStore } from @decwebag/core.
...
22 tests green; full @decwebag/core suite 1194 passed, 1 pre-existing
...
| **Status** | done |
| **Tag** | [NEW] |
| **Notes** | Depends on B2 + B3.  One-shot tool.  v1 scope: device identity migration only.  Full @decwebag/core suite: 1215 tests passed, 13 skipped. |
...
20 tests green; full @decwebag/core suite 1215 passed + 13 skipped).
...
2. SELF_DEVICE_PSEUDO_KEY = '__decwebag:self-device' — a synthetic
