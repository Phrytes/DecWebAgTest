...
- [ ] 1. Create `packages/pod-client/package.json`: `"name": "@decwebag/pod-client"`, `"type": "module"`, `"main": "src/index.js"`, `"@decwebag/core": "file:../core"` dep, `vitest` dev dep, `test` script.
