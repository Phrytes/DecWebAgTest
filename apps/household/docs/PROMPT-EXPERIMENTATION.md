...
(adapter over @decwebag/                  vanishes on restart)
  item-store substrate)
           ...
           ┌────────────────────────────────────────────┐
           │  @decwebag/chat-agent  (substrate L1c)     │
           ...
           └────────────────────┬───────────────────────┘
                                ...
                                ▼
           ┌────────────────────────────────────────────┐
           │  @decwebag/llm-client  (substrate L1j)     │
...
- The two bots **never share state at runtime**.  The production bot
  ...
  are independent.
- The substrate boxes (`@decwebag/chat-agent`, `@decwebag/llm-client`,
...
| **NL fallback parser** | `@decwebag/llm-client` v0.2.0 (`parseLooseToolCalls`) | Hard-coded Dutch + English regex patterns (`is klaar`, `verwijder`, `is done`). |
