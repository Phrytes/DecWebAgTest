 ...
 * `@decwebag/core`'s `PodCapabilityToken`.  We don't fork the
 ...
 */
import { PodCapabilityToken } from '@decwebag/core';
 ...
 * @param {import('@decwebag/core').AgentIdentity} args.botIdentity
