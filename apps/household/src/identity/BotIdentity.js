 ...
 * `@decwebag/core`'s `AgentIdentity` for that lifecycle:
 *
 ...
 * through unchanged.
 */
import { AgentIdentity } from '@decwebag/core';
...
export class BotIdentity {
  /** @type {import('@decwebag/core').Vault} */
  #vault;
  /** @type {import('@decwebag/core').Vault} */
  #namespacedVault;
  /** @type {string|null} */
  ...
  /**
   * @param {object} args
   * @param {import('@decwebag/core').Vault} args.vault
   *   A Vault instance from @decwebag/core (e.g. VaultMemory in
