 ...
 *
 * Free-form list names + LLM-driven dispatch via @decwebag/chat-agent
...
import { ChatAgent } from '@decwebag/chat-agent';
...
export class HouseholdAgentFreeform {
   ...
   *   `@decwebag/llm-client` LlmClient (or any compatible).
   ...
   *   Optional `@decwebag/notifier`-shaped scheduler for digests +
