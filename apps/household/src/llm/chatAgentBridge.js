 ...
 * its LLM slow path to @decwebag/chat-agent's ChatAgent.
 *
 ...
 * @returns {Record<string, import('@decwebag/chat-agent').ToolHandler>}
 */
export function buildHouseholdToolHandlers({ agent, store, scheduler = null } = {}) {
   ...
   * @returns {import('@decwebag/chat-agent').ToolHandler}
   */
