 ...
 * math is consumed from @decwebag/notifier (L1f).  The substrate
...
import { nextDailyFireInTz } from '@decwebag/notifier';
 ...
 *
 * Wraps @decwebag/notifier's `nextDailyFireInTz` (substrate-level
