/**
 * BotPod — wrapper around `@decwebag/pod-client` PodClient + (optional)
 * `@decwebag/core` `OAuthVault`, scoped to the bot's own Solid pod.
 *
...
export class BotPod {
  /** @type {import('@decwebag/pod-client').PodClient} */
  #podClient;
  /** @type {string} */
  #podRoot;
  /** @type {object|null} */
  ...
  /**
   * @param {object} args
   * @param {import('@decwebag/pod-client').PodClient} args.podClient
