...
// @decwebag/react-native subpath so the vitest config alias can
...
vi.mock('@decwebag/react-native/src/transport/MdnsTransport.js', () => ({
  MdnsTransport: class {
    static isAvailable() { return false; }
  },
}));

vi.mock('@decwebag/react-native/src/storage/AsyncStorageAdapter.js', () => ({
