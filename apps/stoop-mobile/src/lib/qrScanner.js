 ...
 * in `@decwebag/react-native/qr/classifyQrPayload`; this file binds
...
import { classifyQrPayload as _classifyQrPayload } from '@decwebag/react-native/qr';
 ...
 * via `@decwebag/react-native/qr` for callers needing custom classifier
 * lists.
 *
 * @param {string} text
 */
