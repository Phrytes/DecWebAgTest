 ...
 *
 * The generic resolver lives in `@decwebag/react-native/i18n` (lifted
 * 2026-05-09 — Phase 41.0 L7). Stoop instantiates it once and re-exports
 * the same module-level API existing call sites use.
 */

import en from '@decwebag-app/stoop/locales/en';
import nl from '@decwebag-app/stoop/locales/nl';
