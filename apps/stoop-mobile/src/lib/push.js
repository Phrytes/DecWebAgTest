 ...
 *
 * Thin wrapper over `@decwebag/react-native`'s `MobilePushBridge` +
...
import { MobilePushBridge }
  from '@decwebag/react-native/src/transport/MobilePushBridge.js';
...
async function _defaultAdapterFactory() {
  const mod = await import('@decwebag/react-native/src/transport/pushAdapters/ExpoNotificationsAdapter.js');
