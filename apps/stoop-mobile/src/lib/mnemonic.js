 ...
 *
 * Lifted to `@decwebag/react-native/mnemonic` 2026-05-09 (Phase 41.0
 ...
 * component) is available at `@decwebag/react-native/mnemonic` /
 * `@decwebag/react-native/mnemonic/view`. Stoop's existing screens
...
export {
  ...
  looksLikeMnemonic,
  statusFor,
} from '@decwebag/react-native/mnemonic';
