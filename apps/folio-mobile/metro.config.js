...
//   - `@decwebag-app/folio/rn/*` subpath imports are intercepted in
//     `resolveRequest` because Metro's `extraNodeModules` doesn't
//     reliably match subpath keys when a shorter prefix (`@decwebag-app/folio`)
//     is also present.
...
config.resolver = {
  ...
  resolveRequest: (context, moduleName, platform) => {
    ...
    // shorter `@decwebag-app/folio` prefix.  Resolve explicitly here.
