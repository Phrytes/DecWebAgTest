# Notes — getting Solid-pod-aware code to bundle on React Native

**Audience:** future me, when the next `@decwebag` mobile slice (or any
RN app talking to Solid pods) hits the same wall.

**Date drafted:** 2026-04-30, against `track-H-folio` branch, as part of
the Folio.C2 mobile bring-up.  This was the first time we actually ran
folio-mobile on a real device after C2 shipped.
