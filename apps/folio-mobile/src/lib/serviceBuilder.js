 ...
 * `@decwebag/sync-engine-rn` substrate (Stoop V3 Phase 40.2,
...
export async function buildEngineForRN(args) {
  const mod = await import('@decwebag-app/folio/rn/serviceFactory');
