...
import { loadLocale } from '@decwebag/react-native/i18n';

import enShared  from '@decwebag-app/tasks-v0/locales/shared/en';
import nlShared  from '@decwebag-app/tasks-v0/locales/shared/nl';
import enDesktop from '@decwebag-app/tasks-v0/locales/en';
import nlDesktop from '@decwebag-app/tasks-v0/locales/nl';
