...
import { GroupManager, AgentIdentity, VaultMemory } from '@decwebag/core';
import { MemberMap, MemberMapCache, buildOnboardingSkills } from '@decwebag/identity-resolver';
import { Notifier, InMemoryScheduleStore, NoopChannel, PushChannel, PushPolicy } from '@decwebag/notifier';
import { wireChat } from '@decwebag/chat-p2p';
import { createPseudoPod, createMemoryBackend } from '@decwebag/pseudo-pod';
import { registerAgentBundle } from '@decwebag/agent-registry';
