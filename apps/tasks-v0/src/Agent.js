 ...
 *
 * Wires:
 *   - `core.Agent` from `@decwebag/core` — real SkillRegistry + dispatch.
 ...
 * `@decwebag/agent-ui`; that wraps `core.A2ATransport` on 127.0.0.1.
 *
...
import { MemberMap, buildIdentitySkills }             from '@decwebag/identity-resolver';
