 ...
 *
 * Plist lives at `~/Library/LaunchAgents/ag.decwebag.folio.plist`.
 * Logs at      `~/Library/Logs/folio/folio.log`.
 *
 * The plist is loaded via:
 *   launchctl load   ~/Library/LaunchAgents/ag.decwebag.folio.plist
 *   launchctl unload ~/Library/LaunchAgents/ag.decwebag.folio.plist
 *
