 ...
 *   - State persistence: `.decwebag/notes-sync-state.json` records the
 ...
 *
 * Design notes:
 *   - SyncEngine extends @decwebag/core's `Emitter` so consumers (CLI, web
...
const STATE_FILE_RELPATH = '.decwebag/notes-sync-state.json';
...
export class SyncEngine extends Emitter {
  ...
  /**
   * @param {object} opts
   * @param {object} opts.podClient                     — @decwebag/pod-client PodClient (or any compatible mock)
