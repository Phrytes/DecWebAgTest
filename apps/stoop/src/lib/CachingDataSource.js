/**
 * CachingDataSource — re-export shim around `@decwebag/local-store`.
 *
 * **2026-05-08:** the implementation lifted into the
 * `@decwebag/local-store` substrate (Tasks V1 = rule-of-two consumer
...
export { CachingDataSource } from '@decwebag/local-store';
