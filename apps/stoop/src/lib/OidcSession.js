 ...
 * needs this, promote into `@decwebag/oidc-session` (or merge with
 * `@decwebag/pod-client`'s `SolidOidcAuth`).
 *
 * Flow:
 *
 ...
 * + Folio's copy into `@decwebag/oidc-session` once a third consumer
 * appears.  Tracked in
