 ...
 *     a WebID for parity).
 *
 * `resolveMember` lives in `@decwebag/identity-resolver`'s
...
import { defineSkill, validateMnemonic, mnemonicToSeed, AgentIdentity } from '@decwebag/core';
import nacl from 'tweetnacl';
import { resolve as resolveMember } from '@decwebag/identity-resolver';
import { validateCanonical } from '@decwebag/item-types';
 ...
 * @param {import('@decwebag/identity-resolver').MemberMap} [members]
 ...
 * `@decwebag/identity-resolver` itself (additive — likely a new
...
/**
 * @param {object} args
 * @param {import('@decwebag/item-store').ItemStore} args.store
 * @param {import('@decwebag/skill-match').SkillMatch} args.skillMatch
...
export function buildSkills({
  ...
  return [
     ...
     * `@decwebag/item-types` shape — `type` + `kind` — via the
