 ...
 *
 * Wires:
 *   - `core.Agent` from `@decwebag/core` — the real SkillRegistry +
...
import { ItemStore } from '@decwebag/item-store';
import { MemberMap, Reveals, buildIdentitySkills }    from '@decwebag/identity-resolver';
 ...
 *   Optional `@decwebag/notifier.Notifier` instance.  When supplied,
 ...
 * @param {import('@decwebag/identity-resolver').Reveals} [args.reveals]
...
export async function createNeighborhoodAgent({
   ...
   * needs (e.g. mDNS / BLE / relay via `@decwebag/react-native`'s
