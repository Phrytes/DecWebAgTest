 ...
 *   via `@decwebag/agent-registry`. Pass `false` to skip
 ...
 * `@decwebag/agent-registry` that supplies the `['stoop']` default
 * capability tag.
 *
 * Shared by web (`attachSubstrateMirror`) and mobile bundle bring-up
 * (`apps/stoop-mobile/src/lib/{agentBundle,bootstrapBundle}.js`).
 * The helper itself was lifted into `@decwebag/agent-registry` on
 ...
 * in favour of the `@decwebag/notify-envelope` + `@decwebag/pseudo-pod`
