# Changelog — @decwebag-app/import-bridge-v0
...
- `@decwebag/sync-engine` (L1a) — primary
- `@decwebag/oauth-vault` (L1g) — per-source credentials
- `@decwebag/identity-resolver/person-graph` (L1h) — cross-source identity
