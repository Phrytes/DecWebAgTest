/**
 * Core types for @decwebag-app/import-bridge-v0.  jsdoc only.
 */
 ...
 * @property {object} oauthVault          `core.OAuthVault` from `@decwebag/core`
 * @property {object} [personGraph]       @decwebag/identity-resolver PersonGraph
