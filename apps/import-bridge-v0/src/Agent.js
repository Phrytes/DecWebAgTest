 ...
 * shape composed `@decwebag/sync-engine`'s V0 `SyncEngine` +
 ...
 *   - `@decwebag/identity-resolver`'s `PersonGraph` — cross-source identity records.
 *
...
import { PersonGraph } from '@decwebag/identity-resolver/person-graph';
