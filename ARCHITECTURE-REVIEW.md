...
Candid snapshot of the @decwebag agent SDK as it stands today. Three sections:
...
apps/
  mesh-demo/        Expo phone app; consumes @decwebag/react-native

examples/
  mesh-demo/        browser demo; consumes @decwebag/core directly
```
...
```
  ...
  transport/
    ...
    RelayTransport.js     WebSocket client to @decwebag/relay
...
```js
// proposed
import { attachTunnelForward } from '@decwebag/core';
...
import { Agent, AgentIdentity, RelayTransport,
         ...
         invokeWithHop } from '@decwebag/core';
